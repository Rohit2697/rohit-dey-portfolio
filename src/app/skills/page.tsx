      ...
      <div className="relative">
        <div className="bg-white/5 rounded-lg border border-white/10 hover:border-green-500/30 transition-colors p-6">
          ...
          <div className="space-y-3">
            {Object.entries(currentProject.tech_stack).map(
              ([category, techs]) => (
      ...
      content: (
        <div className="space-y-6">
          <p className="text-lg mb-6">
            As a{' '}
            <strong className="text-green-400">Full Stack Developer</strong>{' '}
            with expertise across multiple technologies, I bring comprehensive
            skills in modern web development, cloud platforms, and emerging
            technologies.
          </p>
          ...
          <div className="mt-6 p-4 bg-green-500/10 rounded-lg border border-green-500/30">
            <p className="text-green-400 font-medium">
              🚀 On the way to add more skills and technologies!
            </p>
          </div>
        </div>
      ),
      ...
      content: (
        <div className="space-y-6">
          <p className="text-lg mb-6">
            ...
            industry-recognized certifications and comprehensive courses in{' '}
            <strong className="text-green-400">modern web technologies</strong>.
          </p>
          ...
          <div className="mt-6 text-center">
            <div className="inline-flex items-center space-x-2 bg-green-500/20 text-green-400 px-4 py-2 rounded-full border border-green-500/30">
              <span>🏆</span>
              <span className="font-medium">
                {certificates.length} Certifications Completed
              </span>
            </div>
          </div>
        </div>
      ...
      content: (
        <div className="space-y-6">
          <p className="text-lg mb-6">
            ...
            <strong className="text-green-400">full-stack development</strong>,
            AI integration, and modern web technologies. Each project represents
            a unique challenge and solution.
          </p>
          <ProjectCarousel
            projects={projects}
            onProjectChange={handleProjectImageChange}
          />
        </div>
      ),
    },
